...
public class AutoUpgradeClient {
    ...
    private static void showHintDialog(final UpgradeBean upgradeBean) {
        ...
        AlivcCustomAlertDialog alivcCustomAlertDialog = new AlivcCustomAlertDialog.Builder(sContext)
                ...
                .setDialogClickListener(sContext.getResources().getString(R.string.aliyun_common_update_now), "", new AlivcCustomAlertDialog.OnDialogClickListener() {
                    @Override
                ...
                .create();
        alivcCustomAlertDialog.setCancelable(false);
        alivcCustomAlertDialog.show();
    }
